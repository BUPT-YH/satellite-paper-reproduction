...
AI 模型想要性能出色，尚且需要高质量的训练数据；人的大脑又何尝不是如此？输入决定输出，读什么样的论文，很大程度上决定了你能成为什么样的研究者。
...
精选论文、动手复现、反复研读——只需假以时日，卫星通信领域的大门自然会向你敞开。

---

本仓库所有内容均为**免费开源**，维护于本人的业余休息时间。做这件事的初衷，是希望能帮助到和我一样、在研究生初期迷茫焦虑、看论文看到晕头转向的同学们——哪怕只带来一点微光，也算值得。
