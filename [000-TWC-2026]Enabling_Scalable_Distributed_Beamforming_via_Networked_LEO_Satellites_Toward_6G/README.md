...
```
[000-TWC-2026]Enabling_Scalable_Distributed_Beamforming_via_Networked_LEO_Satellites_Toward_6G/
├── config.py              # 仿真参数配置
...
```bash
cd "C:\Users\windows\Desktop\文章复现\[000-TWC-2026]Enabling_Scalable_Distributed_Beamforming_via_Networked_LEO_Satellites_Toward_6G"
